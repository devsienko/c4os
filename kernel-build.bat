...
ld -T src\kernel\kernel.ld -o bin\disk\kernel.bin bin\startup.o bin\stdlib.o bin\memory_manager.o bin\main.o bin\timer.o bin\tty.o bin\dma.o bin\floppy.o bin\interrupts_asm.o bin\interrupts.o
